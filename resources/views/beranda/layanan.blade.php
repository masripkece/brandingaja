...
<head>
  <meta charset="UTF-8">
  <title>Layanan | BrandinginAja</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">

  <script src="https://cdn.tailwindcss.com"></script>
  <script defer src="https://unpkg.com/alpinejs@3.x.x/dist/cdn.min.js"></script>
</head>
<body class="bg-[#08b3ad] text-white">

{{-- ================= NAVBAR (PASTE DARI INDEX) ================= --}}
...
<section class="px-6 pt-32 pb-20">
  <div class="max-w-7xl mx-auto">
    ...
    <h1 class="text-5xl font-bold mb-6">
      Layanan <span class="text-yellow-400 italic">Kami</span>
    </h1>

    <div class="inline-block bg-yellow-400 text-white font-semibold px-10 py-3 rounded-full mb-16">
      Ada Apa aja Sii??
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
      ...
      <!-- SOSIAL MEDIA -->
      <div class="bg-white text-[#06a19d]  rounded-[32px] p-10 shadow-xl relative">
        <h2 class="text-3xl font-bold mb-6">Sosial Media</h2>

        <p class="leading-relaxed text-lg ">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          Admin e-commerce bertanggung jawab dalam pengelolaan sistem,
          pengaturan pengguna, serta pengawasan aktivitas transaksi
          agar berjalan sesuai ketentuan yang berlaku. Admin tidak
          terlibat langsung dalam proses jual beli, melainkan berperan
          sebagai pengendali operasional dan keamanan.
        </p>
      </div>
      ...
      <div class="bg-white text-[#06a19d] rounded-[32px] p-10 shadow-xl relative">
        ...
        <p class="leading-relaxed text-lg">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          Admin e-commerce bertanggung jawab dalam pengelolaan sistem,
          pengaturan pengguna, serta pengawasan aktivitas transaksi agar
          berjalan sesuai ketentuan yang berlaku. Admin berperan sebagai
          pengendali operasional dan keamanan sistem digital.
        </p>
      </div>
