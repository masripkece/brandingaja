...
<head>
  <meta charset="UTF-8">
  <title>Jaringan | BrandinginAja</title>
...
<section class="px-6 pt-32 pb-28">
  <div class="max-w-6xl mx-auto text-center">
    ...
    <h1 class="text-5xl font-bold mb-6">
      Bergabung Menjadi <span class="text-yellow-400 italic">Jaringan</span>
    </h1>

    <p class="max-w-3xl mx-auto text-lg opacity-90 mb-14">
      Pelajari cara bergabung sebagai jaringan dan membangun kolaborasi
      bersama BrandinginAja melalui video tutorial berikut.
    </p>
    ...
    <div class="bg-yellow-400 rounded-[40px] p-6 shadow-2xl">
      <div class="aspect-video rounded-3xl overflow-hidden">
        <iframe
          class="w-full h-full"
          src="https://www.youtube.com/embed/n8wAvghXLz0"
          title="Tutorial Jaringan BrandinginAja"
          frameborder="0"
