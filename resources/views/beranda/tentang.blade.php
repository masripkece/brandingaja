...
<head>
  <meta charset="UTF-8">
  <title>Tentang Kami | BrandinginAja</title>
...
{{-- ================= NAVBAR (PASTE SAMA DENGAN BERANDA) ================= --}}
  ...
  <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
    ...
    <div>
      <h1 class="text-5xl font-bold mb-6">
        Tentang <span class="text-yellow-400 italic">Kami</span>
      </h1>
...
<section class="px-6 py-24 bg-gray-50">
  <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div class="bg-[#08b3ad] text-white rounded-2xl p-8 shadow-lg">
      ...
      <p class="leading-relaxed opacity-90 text-white">
